...
<div class="prose">
	...
	<h1>Privacy Policy for Meruem Gaming</h1>

	<p>
		At Meruem Gaming, accessible from https://www.mlbbhero.com, one of our main priorities is the
		privacy of our visitors. This Privacy Policy document contains types of information that is
		collected and recorded by Meruem Gaming and how we use it.
	</p>
	...
	<p>
		...
		website with regards to the information that they shared and/or collect in Meruem Gaming. This
	...
	<p>
		Meruem Gaming follows a standard procedure of using log files. These files log visitors when
	...
	<p>
		Like any other website, Meruem Gaming uses 'cookies'. These cookies are used to store
	...
	<ul>
		<li>
			<p>Google</p>
			<p>
				<a rel="external" href="https://policies.google.com/technologies/ads"
					>https://policies.google.com/technologies/ads</a
				>
			</p>
		</li>
	...
	<p>
		...
		that are used in their respective advertisements and links that appear on Meruem Gaming, which
	...
	<p>
		Note that Meruem Gaming has no access to or control over these cookies that are used by
	...
	<p>
		Meruem Gaming's Privacy Policy does not apply to other advertisers or websites. Thus, we are
	...
	<p>
		Meruem Gaming does not knowingly collect any Personal Identifiable Information from children
