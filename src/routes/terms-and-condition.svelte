...
<div class="prose">
	<hr class="bg-base-100 border-2 my-10" />

	<h2><strong>Terms and Conditions</strong></h2>

	<p>Welcome to Meruem Gaming!</p>

	<p>
		These terms and conditions outline the rules and regulations for the use of Mobile Legends
		World's Website, located at https://www.mlbbhero.com.
	</p>

	<p>
		By accessing this website we assume you accept these terms and conditions. Do not continue to
		use Meruem Gaming if you do not agree to take all of the terms and conditions stated on this
		page.
	</p>
	...
	<p>
		We employ the use of cookies. By accessing Meruem Gaming, you agreed to use cookies in agreement
		with the Meruem Gaming's Privacy Policy.
	</p>
	...
	<p>
		Unless otherwise stated, Meruem Gaming and/or its licensors own the intellectual property rights
		for all material on Meruem Gaming. All intellectual property rights are reserved. You may access
		this from Meruem Gaming for your own personal use subjected to restrictions set in these terms
		and conditions.
	</p>

	<p>You must not:</p>
	<ul>
		<li>Republish material from Meruem Gaming</li>
		<li>Sell, rent or sub-license material from Meruem Gaming</li>
		<li>Reproduce, duplicate or copy material from Meruem Gaming</li>
		<li>Redistribute content from Meruem Gaming</li>
	</ul>
	...
	<p>
		...
		information in certain areas of the website. Meruem Gaming does not filter, edit, publish or
		review Comments prior to their presence on the website. Comments do not reflect the views and
		opinions of Meruem Gaming,its agents and/or affiliates. Comments reflect the views and opinions
		of the person who post their views and opinions. To the extent permitted by applicable laws,
		Meruem Gaming shall not be liable for the Comments or for any liability, damages or expenses
		caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
		Comments on this website.
	</p>

	<p>
		Meruem Gaming reserves the right to monitor all Comments and to remove any Comments which can be
	...
	<p>
		You hereby grant Meruem Gaming a non-exclusive license to use, reproduce, edit and authorize
	...
	<p>
		...
		hyperlink compensates the absence of Meruem Gaming; and (d) the link is in the context of
	...
	<p>
		...
		our website, you must inform us by sending an e-mail to Meruem Gaming. Please include your name,
	...
	<p>
		No use of Meruem Gaming's logo or other artwork will be allowed for linking absent a trademark
		license agreement.
	</p>
	...
	<p>Please read <a class="link" href="/privacy-policy"> Privacy Policy</a></p>
